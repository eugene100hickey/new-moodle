...
Astrophysics research has never been more active. There are numerous fundamental questions being addressed, with _big science_ missions to match. Because so much material is freely available to be analysed, it's a wonderful time for citizen scientists.
...
- not much as the star is so much more massive
    ...
    - our Sun does 500km _wobble_ every year because of Earth's orbit
