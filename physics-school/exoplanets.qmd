...
title: "Exoplanets"
author:
  - name: Physics TUD - October 13<sup>th</sup> 2026
...
- not much as the star is so much more massive
  ...
  - our Sun does 2000km *wobble* every year because of Earth's orbit
  
  - about 6cm per second
...
- planet eclipses host star

    - Jupiter would dim our sun by 1%
    
![](images/odhran-cully-transit.png){data-credits="Odhran Cully MSc Thesis 2026"}

## $\micro$lensing

- looking at a bright background star, normally just detect the light emitted directly towards us

- but if something passes in between, the _something's_ gravitational field can bend more light to us

- background object gets a little brighter for a while
