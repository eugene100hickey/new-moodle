...
6.  safety aspects of radioactivity
7.  measurement of radiation / units radiation limits
...
-   $\alpha$ decay is caused by Coulomb Repulsion between protons
    ...
    -   heavy nuclei want to offload some nucleons
        ...
        -   but for some lifetimes are so long we don't consider them radioactive, e.g. $^{204}Pb$ with half-life of $1.4 \times 10^{17}$ years.

        -   also, sometimes $\beta$ deacy more likely so it masks the $\alpha$'s.
...
uranium <- tribble(~isotope, ~half_life, ~Q, ~series,
                   "U238", 1.408416e+17, 4.19, "U",
                   "U236", 7.39079e+14, 4.50, "U",
                   "U234", 7.747391e+12, 4.77, "U",
                   "U232", 2174318640, 5.41, "U",
                   "U230", 1771200, 5.99, "U",
                   "U228", 546, 6.804, "U",
                   "Th232", 4.449622e+17, 4.01, "Th",
                   "Th230", 2.524608e+12, 4.68, "Th",
                   "Th228", 6027501600, 5.42, "Th",
                   "Th226", 1836, 6.451, "Th")
uranium |> 
  ggplot(aes(Q, half_life, group = series)) + 
  geom_line() + 
  labs(title = TeX("Log Half-Life versus $\\alpha$ Energy for Some Even-Even Isotopes"),
      y = "Isotope Half-Life (s)",
      x = "Q (MeV)") +
  scale_y_log10(labels = label_log(digits = 2)) +
  geom_label(aes(label = isotope, colour = series), size = 16, show.legend = F) +
  scale_colour_manual(values = c("firebrick4", "darkblue")) +
  theme_minimal() + 
  theme(text = element_text(family = "Ink Free", size = 80), 
        plot.title = element_text(size = 100, hjust = 1))
```
...
-   actually three types of $\beta$ decay
    ...
    -   negative $\beta$ decay: $n \rightarrow p \; + \; e^-$ this is $\beta^-$

    -   negative $\beta$ decay: $p \rightarrow n \; + \; e^+$ this is $\beta^+$

    -   orbital electron capture: $p \; + \; e^- \rightarrow n$ this is $\epsilon$
...
$^1H \; + \; ^1H \; \rightarrow \; ^2H \; + \; e^+ \; + \; \nu$ $^2H \; + \; ^2H \; \rightarrow \; ^4He \; + \; \gamma$ $^2H \; + \; ^2H \; \rightarrow \; ^3He \; + n$ $^2H \; + \; ^2H \; \rightarrow \; ^3H \; + \; p$ $^2H \; + \; ^3H \; \rightarrow \; ^4He \; + \; n$ $^2H \; + \; ^1H \; \rightarrow \; ^3He \; + \; \gamma$ $^3H \; + \; ^1H \; \rightarrow \; ^4Li$ $^3He \; + \; ^3He \; \rightarrow \; ^4He \; + \; 2\times ^1H + \; \gamma$ $^4He \; + \; ^4He \; \rightarrow \; ^8Be$ $^{12}C \; + \; ^4He \; \rightarrow \; ^{16}O \; + \; \gamma$ $^{16}O \; + \; ^4He \; \rightarrow \; ^{20}Ne \; + \; \gamma$ $^{20}Ne \; + \; ^4He \; \rightarrow \; ^{24}Mg \; + \; \gamma$ $^{12}C \; + \; ^{12}C \; \rightarrow \; ^{20}Ne \; + \; ^4He$ $^{16}O \; + \; ^{16}O \; \rightarrow \; ^{28}Si \; + \; ^4He$ $^{12}C \; + \; ^{12}C \; \rightarrow \; ^{23}Na \; + \; ^1H$ $^{16}O \; + \; ^{16}O \; \rightarrow \; ^{31}P \; + \; ^1H$
