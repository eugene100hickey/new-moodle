...
- this is **_nuclear fusion_**

- energy ggain is $\times$ 10 higher (curve is steeper)

- _but_ have to overcome Coulomb barrrier before get close enough to combine
...
- this step is the **_bottleneck_** in the solar fusion chain

    - the $\nu$ in the reaction means it must feature a _weak_ interaction, low probability
    
    - in the core of the Sun, the temperature is about 15 million Kelvin and this gives a reaction rate of $5 \times 10^{-18} s^{-1}$ per proton.
...
- proton-proton cycle is engine in _Main Sequence_ stars
