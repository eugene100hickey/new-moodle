...
- only possible is we *borrow* energy using the uncertainty principle
    ...
    - $\Delta t$ given by time taken to cross nucleus at speed of light
        ...
        - this gives $\Delta E \approx \frac{\hbar c}{R c^2}$
        
        - gives a particle of about 200MeV (c.f. proton 938MeV, electron 0.511MeV)
        
        - eventually discovered the **Pion** ($\pi^{\circ} \; and \; \pi^{\pm}$), which is made up a quark and anti--quark.
...
-   roughly spherical, a little oblate. Usually.
