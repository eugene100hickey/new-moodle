...
Something has to hold the nucleus together. Some properties of this _nuclear force_
...
- no analytic form of nuclear force
    ...
    - nothing like Coulomb's Law
    
$$F_{Coulomb} \; = \; \frac{1}{4 \pi \epsilon_{\circ}} \; \frac{q_1 q_2}{r^2}$$

- best modelled as an _exchange_ force, mediated by some particle
...
- can get a bound state of a single proton and a single neutron, called _deuteron_ (c.f. deuterium, $^2H$)

- don't get _proton-proton_ or _neutron-neutron_
