...
-   $\alpha$ decay is caused by Coulomb Repulsion between protons
    ...
    -   heavy nuclei want to offload some nucleons
        ...
        -   also, sometimes $\beta$ decay more likely so it masks the $\alpha$'s.
...
-   bigger range of energies than $\alpha$ particles
    -   3.5MeV for $^{137}_{54}Xe \; \rightarrow \; ^{137}_{55}Cs \;+ \; \beta \; + \; \bar{\nu}$
    -   18keV for $^{3}_{1}T \; \rightarrow \; ^{3}_{2}He \;+ \; \beta \; + \; \bar{\nu}$
...
-   [Radioactive decay series](https://ebookcentral.proquest.com/lib/tudublin/reader.action?docID=5139105&c=UERG&ppg=1610){target="_blank"}
