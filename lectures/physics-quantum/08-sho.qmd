...
For the next application of the Schrödinger Equation, we'll look at a particle undergoing simple harmonic motion (SHO). This particle is in a parabolic potential and classically exhibits the kind of motion typical of pendula or stretched springs.
...
- various solutions depend on:
    ...
    - the boundary conditions
        - these lead to __quantisation__
...
- $\psi(x)$ carries all the information we can get about measurements we'll get on the particle
    ...
    + $\bar{x} =-i\hbar \int_{-\infty}^{+\infty} \psi_n(x)  \frac{\partial}{\partial x} \psi_n(x) dx = \vec{p_x}$ gives particle momentum
    
    - $\bar{x} =-i\hbar \int_{-\infty}^{+\infty} \psi_n(x)  (y \frac{\partial}{\partial z} - z \frac{\partial}{\partial y}) \psi_n(x) dx = \vec{L_x}$ gives particle angular momentum
...
::::: columns
::: {.column width="100%"}
-   _$V(x) = ½ kx^2 = ½ m \omega ^2x^2$_
-   _$\omega = \sqrt{k/m} = 2 \pi f$_
- $\psi(x) = N_{\nu} H_{\nu}(x) e^{\frac{-x^2}{2}}$
- $N_{\nu} = \sqrt{\frac{1}{2^{\nu} \nu ! \sqrt{\pi}}}$
- $H_{\nu}(x) = (-1)^{\nu} e^{x^2} \frac{d^{\nu}}{dx^{\nu}} e^{-x^2}$
-  _$E_{\nu} = (\nu + \frac{1}{2})\hbar \omega$_
:::
