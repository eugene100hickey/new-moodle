...
The natural distance scale for the nucleus is the femtometre (1 fm = $10^{-15}m$), the natural energy or mass unit is the mega electron volt ($1MeV = 1.6 \times 10^{-19}J = 1.78 \times 10^{-30}kg$)
...
-   hits a maximum of \~8.75 MeV around $^{56}Fe$ (well, actually $^{60}Co$)
