...
- $Gray =  Bq \times (energy\;in\;joules) / (person\;mass\; in \;kg)$

- $Sv = Bq \times (energy\;in\;joules) \times RBE / (person\;mass\; in \;kg)$

- (expected number of deaths) = (dose in Sievert) $\times$ (population) / 50
