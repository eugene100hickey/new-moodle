...
-   Z increases by 1 and A remains the same
    -   $^A_DP\;=>\;^{A}_{Z+1}D\;+\;\beta \; + \; \mu$
-   examples
    -   $^{99}_{42}Mo\;=>\;^{99}_{43}Tc\;+\;\beta \; + \; \mu$
    -   $^{14}_{6}C\;=>\;^{14}_{7}N\;+\;\beta \; + \; \mu$
...
-   bigger range of energies than $\alpha$ particles
    -   3.5MeV for $^{137}_{54}Xe \; \rightarrow \; ^{137}_{55}Cs \;+ \; \beta \; + \; \mu$
    -   18keV for $^{3}_{1}T \; \rightarrow \; ^{3}_{2}He \;+ \; \beta \; + \; \mu$
